...
#define STRING_CONFIG_H_AUTHOR "(Clement S, BigBox Pro TMC2130 BLTouch)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    //Tuned
    #define  DEFAULT_Kp 27.22
    #define  DEFAULT_Ki 02.43
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 180, 1600, 313 }
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 150, 150, 6, 50 }  //{ 300, 300, 5, 25 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 1.1, 31.9, -1 }
...
#define INVERT_X_DIR false  // bc TMC2130
#define INVERT_Y_DIR true   // bc TMC2130
#define INVERT_Z_DIR true   // bc TMC2130
...
#define INVERT_E0_DIR false // bc TMC2130
...
#define X_MIN_POS -14.4
#define Y_MIN_POS -2.5
#define Z_MIN_POS 0
#define X_MAX_POS 306.5 //X_BED_SIZE
#define Y_MAX_POS 207   //Y_BED_SIZE //232 for parking 
...
#define HOMING_FEEDRATE_MM_M { (45*60), (50*60), (4*60) }
